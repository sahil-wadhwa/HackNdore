...
// Fetch supplies using fetch API
...
const rows: GridRowsProp = [
  ...
  { id: 3, col1: 'paint', col2: 'Finance', col3: '742-74', col4: 114, col5: 16, col6: 42, col7: 93, col8: 397.37 },
];
...
export default function DataSupplies() {
  return (
